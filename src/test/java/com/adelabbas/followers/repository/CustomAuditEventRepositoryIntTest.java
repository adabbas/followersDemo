package com.adelabbas.followers.repository;

import com.adelabbas.followers.FollowersApp;
import com.adelabbas.followers.config.Constants;
import com.adelabbas.followers.config.audit.AuditEventConverter;
import com.adelabbas.followers.domain.PersistentAuditEvent;
...
import static com.adelabbas.followers.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
